...
HD_PWD='D:/Documents/Project/radiation_detection_pynq/radiation_detector/radiation_detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log radiation_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source radiation_system_wrapper.tcl
